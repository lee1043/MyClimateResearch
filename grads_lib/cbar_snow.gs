...
*
 ...
 if (num=0|num=2|num=4|num=6|num=8|num=10|num=12|num=14|num=16|num=18|num=20|num=22|num=24|num=26|num=28|num=30|num=32|num=34|num=36|num=38|num=40|num=42|num=44|num=46|num=48|num=50)
      if (vert) 
  ...
  endwhile
   ...
   if (vert)
     'draw string '%(xr+0.05)%' 'yt+0.1' (cm)'
   else
     'draw string 'xr+0.1' '%(yb-0.05)%' (cm)'
   endif
