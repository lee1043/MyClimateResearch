...
*    'draw rec 'xl' 'yb' 'xr' 'yt
    ...
    if (num<cnum-1)
     if (hi=0.2|hi=0.4|hi=0.6|hi=0.8|hi=1.0|hi=-0.2|hi=-0.4|hi=-0.6|hi=-0.8|hi=-1.0)
      if (vert) 
        xp=xr+stroff
...
*       'draw line 'xr' 'yt' 'xl' 'ym
    ...
    if (num<cnum-1)
     if (hi=0.2|hi=0.4|hi=0.6|hi=0.8|hi=1.0|hi=1.2|hi=1.4|hi=-0.2|hi=-0.4|hi=-0.6|hi=-0.8|hi=-1.0|hi=-1.2|hi=-1.4)
      if (vert)
         xp=xr+stroff 
        'draw string 'xp' 'yt' 'hi
      else
