...
*datdir='/home/jwlee/UTIL/gslib/basemap'
datdir='/u/xue/jiwoo/UTIL/gslib/basemap'

if (type = 'L' | type = 'l') 
*  if (lowres); file = 'lpoly_US.asc'; endif
  if (lowres); file = ''datdir'/lpoly_lowres.asc'; endif
  if (mres)  ; file = ''datdir'/lpoly_mres.asc'  ; endif
  if (hires) ; file = ''datdir'/lpoly_hires.asc' ; endif
endif
if (type = 'O' | type = 'o') 
  if (lowres); file = ''datdir'/opoly_lowres.asc'; endif
  if (mres)  ; file = ''datdir'/opoly_mres.asc'  ; endif
  if (hires) ; file = ''datdir'/opoly_hires.asc' ; endif
endif
