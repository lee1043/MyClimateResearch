...
* if (hi=0|hi=5|hi=10|hi=20|hi=30|hi=50|hi=100|hi=150|hi=200|hi=250|hi=300|hi=350|hi=400)
* if (hi=0|hi=5|hi=10|hi=20|hi=30|hi=50|hi=100|hi=150|hi=200|hi=250|hi=300|hi=350|hi=400)
 if (hi=1|hi=5|hi=10|hi=15|hi=20|hi=25|hi=30|hi=35|hi=40|hi=45|hi=50|hi=55|hi=60)
      if (vert) 
  ...
  endwhile
   ...
   if (vert)
     ...
     'draw string 'xr+0.15' '%(yb-0.05)%' (mm)'
   endif
